      ...
      describe('throw', () => {
        it('plural', () => {
          ...
          expect(() => translate`plural`).toThrowErrorMatchingInlineSnapshot(
            '"invalid translate: \\"undefined\\"; as a json: undefined. full path: \\"screens.Home.plural\\"; translate path: \\"plural\\";"'
          );
        });
        ...
        it('broken path', () => {
          ...
          expect(() => translate`Home`).toThrowErrorMatchingInlineSnapshot(
            '"invalid translate: \\"undefined\\"; as a json: undefined. full path: \\"screens.Home\\"; translate path: \\"Home\\";"'
          );
        });
      });
